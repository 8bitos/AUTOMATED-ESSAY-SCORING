  ...
  const handleAutoGenerate = async (forceOverwrite = false) => {
    ...
    try {
      ...
      const res = await fetch(endpoint, {
        ...
        credentials: 'include',
        body: JSON.stringify({
          teks_soal: hasManualQuestion ? teksSoal.trim() : undefined,
          rubric_type: rubricType,
      ...
      if (!usesGlobalRubric) {
        ...
        const normalizedType: RubricType =
          generated.rubric_type === 'holistik' || generated.rubric_type === 'analitik'
            ...
            : rubricType;
        if (shouldFillRubrics) {
          setRubricType(normalizedType);
        }

        if (normalizedType === 'analitik' && shouldFillRubrics) {
        ...
        } else if (normalizedType === 'holistik' && shouldFillRubrics) {
