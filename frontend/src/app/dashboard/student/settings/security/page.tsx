  ...
  return (
    <div className="space-y-6">
      <div className="sage-panel p-6">
        ...
        <p className="text-sm text-slate-500">Kelola password untuk menjaga keamanan akun siswa.</p>
      </div>
        ...
        <aside className="lg:sticky lg:top-6">
          <div className="sage-panel p-6 space-y-4">
            ...
            <p className="text-sm text-slate-600 leading-relaxed text-justify">
              Gunakan password kuat minimal 6 karakter, dan ubah password secara berkala agar akun tetap aman.
            </p>
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs text-slate-600">
              Tips: pakai kombinasi huruf besar, huruf kecil, angka, dan simbol agar password lebih kuat.
            </div>
          </div>
        </aside>
      </div>
