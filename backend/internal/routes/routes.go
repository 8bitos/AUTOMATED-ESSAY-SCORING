...
func SetupRoutes(router *mux.Router, db *sql.DB, materialService *services.MaterialService, essayQuestionService *services.EssayQuestionService) {
	...
	notificationRealtimeHandlers := handlers.NewNotificationRealtimeHandlers()
	...
	protectedRouter.HandleFunc("/notifications/stream", notificationRealtimeHandlers.StreamHandler).Methods("GET")
	protectedRouter.HandleFunc("/notifications", notificationHandlers.ListNotificationsHandler).Methods("GET")
	protectedRouter.HandleFunc("/notifications/read", notificationHandlers.MarkNotificationsReadHandler).Methods("POST")
	protectedRouter.HandleFunc("/notifications/read-all", notificationHandlers.MarkAllNotificationsReadHandler).Methods("POST")
	...
	teacherRouter.HandleFunc("/grade-appeals", gradeAppealHandlers.ListTeacherGradeAppealsHandler).Methods("GET")
	teacherRouter.HandleFunc("/grade-appeals/{appealId}/review", gradeAppealHandlers.ReviewGradeAppealHandler).Methods("PUT")
	...
	adminRouter.HandleFunc("/ai-config/provider", adminOpsHandlers.AdminGetAIProviderHandler).Methods("GET")
	adminRouter.HandleFunc("/ai-config/provider", adminOpsHandlers.AdminUpdateAIProviderHandler).Methods("PUT")
	adminRouter.HandleFunc("/ai-config/litellm", adminOpsHandlers.AdminGetLiteLLMConfigHandler).Methods("GET")
	adminRouter.HandleFunc("/ai-config/litellm/reveal", adminOpsHandlers.AdminRevealLiteLLMKeyHandler).Methods("POST")
	adminRouter.HandleFunc("/ai-config/litellm", adminOpsHandlers.AdminUpdateLiteLLMConfigHandler).Methods("PUT")
	adminRouter.HandleFunc("/ai-config/test", adminOpsHandlers.AdminTestAIConnectionHandler).Methods("POST")
